  ...
  return (
    <div className="mt-4 rounded-[4px] flex flex-col xl:flex-row xl:gap-10 gap-5">
      <div className="bg-white rounded-[4px] p-3 sm:p-4 xl:w-[60%] flex flex-col gap-3">
        <p className="text-[13px] font-[500]">Awesome 4 favourite tasks</p>
        <ProgressBar title={"Task A"} progress={"w-[100%]"} value={729} />
        <ProgressBar title={"Task B"} progress={"w-[80%]"} value={514} />
        <ProgressBar title={"Task C"} progress={"w-[60%]"} value={127} />
        <ProgressBar title={"Task D"} progress={"w-[40%]"} value={88} />
      </div>
...
export default TeamTaskAnalytics;
